    ...
    <div className={styles.sobreContainer}>
      ...
      <div className={styles.description}>
        <p>
          ...
          Atualmente trabalhando como <strong>Engenheiro de Software</strong> no <strong>Sicredi</strong>.
        </p>
      </div>
      ...
      <div className={styles.linguagensContainer}>
        <h2>Linguagens</h2>
        <div>
          {LINGUAGENS.map(linguagem => <span key={linguagem}>{linguagem}</span>)}
        </div>
      </div>
      ...
      <div className={styles.empresasContainer}>
        <h2>Empresas</h2>
        <div>
          <a href="https://www.sicredi.com.br/" target="_blank" rel="noopener noreferrer">
            <Image src={logoSicrediImg} alt='Sicredi'/>
          </a>
          <a href="https://compass.uol/" target="_blank" rel="noopener noreferrer">
            <Image src={logoCompassUolImg} alt='Compass UOL'/>
          </a>
          <a href="https://www.dpabrasil.com.br/" target="_blank" rel="noopener noreferrer">
